// Message type: envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.HeaderToMetadata.KeyValuePair
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.HeaderToMetadata.KeyValuePair';
local generator = import '../generator.libsonnet';
local fields = {
  encode: {
    type: 'envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.HeaderToMetadata.ValueEncode',
    allowedNames: [
      'encode',
    ],
  },
  ...
  type: {
    type: 'envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.HeaderToMetadata.ValueType',
    allowedNames: [
      'type',
    ],
    constraints: {
...

{
  definition: {
    ...
    withEncode:: function(val) validator.validateField(self + { encode: val }, 'encode', type + '.withEncode'),
