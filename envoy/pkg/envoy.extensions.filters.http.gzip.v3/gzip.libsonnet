// Message type: envoy.extensions.filters.http.gzip.v3.Gzip
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.extensions.filters.http.gzip.v3.Gzip';
...

{
  definition: {
    ...
    withCompressor:: function(val) validator.validateField(self + { compressor: val }, 'compressor', type + '.withCompressor'),
