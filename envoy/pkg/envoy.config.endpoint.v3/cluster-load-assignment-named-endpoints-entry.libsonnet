// Message type: envoy.config.endpoint.v3.ClusterLoadAssignment.NamedEndpointsEntry
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.config.endpoint.v3.ClusterLoadAssignment.NamedEndpointsEntry';
