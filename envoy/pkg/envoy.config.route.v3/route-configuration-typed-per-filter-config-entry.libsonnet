// Message type: envoy.config.route.v3.RouteConfiguration.TypedPerFilterConfigEntry
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.config.route.v3.RouteConfiguration.TypedPerFilterConfigEntry';
