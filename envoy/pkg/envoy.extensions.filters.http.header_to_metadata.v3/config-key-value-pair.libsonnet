// Message type: envoy.extensions.filters.http.header_to_metadata.v3.Config.KeyValuePair
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.extensions.filters.http.header_to_metadata.v3.Config.KeyValuePair';
local generator = import '../generator.libsonnet';
local fields = {
  encode: {
    type: 'envoy.extensions.filters.http.header_to_metadata.v3.Config.ValueEncode',
    allowedNames: [
      'encode',
    ],
  },
  ...
  type: {
    type: 'envoy.extensions.filters.http.header_to_metadata.v3.Config.ValueType',
    allowedNames: [
      'type',
    ],
    constraints: {
