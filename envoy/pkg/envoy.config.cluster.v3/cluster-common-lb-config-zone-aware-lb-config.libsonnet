// Message type: envoy.config.cluster.v3.Cluster.CommonLbConfig.ZoneAwareLbConfig
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.

local type = 'envoy.config.cluster.v3.Cluster.CommonLbConfig.ZoneAwareLbConfig';
