// Enum type: google.protobuf.NullValue
// Definition generated by protoc-gen-jsonnet. DO NOT EDIT.
local type = 'google.protobuf.NullValue';
local map = {
...
{
  definition: map {
    _new:: function(obj={}) error '%s: the _new method may not be used on enum types' % 'google.protobuf.NullValue',
    _validate:: validator,
  },
  validator:: validator,
}
